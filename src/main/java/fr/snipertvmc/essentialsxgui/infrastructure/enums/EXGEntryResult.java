...
public enum EXGEntryResult {
	...
	INVALID_MINIMESSAGE_FORMAT(EXGMessage.INVALID_MINIMESSAGE_FORMAT, EXGSound.ACTION_FAILURE),
	INVALID_LEGACY_FORMAT(EXGMessage.INVALID_LEGACY_FORMAT, EXGSound.ACTION_FAILURE),
	INVALID_MIXED_FORMAT(EXGMessage.INVALID_MIXED_FORMAT, EXGSound.ACTION_FAILURE),
